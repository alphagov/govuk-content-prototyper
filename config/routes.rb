Rails.application.routes.draw do
  ...
  get '/guidance/using-meditation-to-create-a-culture-of-respect-and-trust', to: 'dfe#content_page_1_1'
  get '/guidance/using-ground-rules-to-create-a-culture-of-respect-and-trust', to: 'dfe#content_page_1_2'

  get '/government/publications/supporting-early-career-teachers--2/promote-good-progress', to: 'dfe#content_page_2'
  get '/guidance/measuring-pupil-progress-and-managing-the-data', to: 'dfe#content_page_2_1'
  ...
  get '/guidance/improving-the-appropriate-wait-time-between-question-and-response-in-class', to: 'dfe#content_page_3_1'
  get '/guidance/sharing-planning-tasks-in-schools', to: 'dfe#content_page_3_2'

  get '/government/publications/supporting-early-career-teachers--2/adaptive-teaching', to: 'dfe#content_page_4'
  get '/guidance/making-effective-use-of-teaching-assistants', to: 'dfe#content_page_4_1'
  get '/guidance/using-technology-to-aid-school-improvement', to: 'dfe#content_page_4_2'

  get '/government/publications/supporting-early-career-teachers--2/manage-behaviour-effectively', to: 'dfe#content_page_5'
  get '/guidance/how-can-you-manage-behaviour-in-the-classroom', to: 'dfe#content_page_5_1'
  ...
  get '/guidance/ask-for-challenge-and-feedback-from-mentors-and-other-colleagues', to: 'dfe#content_page_6_1'
  get '/guidance/supporting-nqts-and-teachers-with-work-life-balance', to: 'dfe#content_page_6_2'
  ...
  get '/guidance/reviewing-feedback-and-marking-in-schools', to: 'dfe#content_page_8_1'

  get '/guidance/roll-out-of-the-early-career-framework', to: 'dfe#content_page_9'
